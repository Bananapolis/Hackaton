...
function GoogleButton({ onSuccess, onError, disabled }) {
  ...
  return (
    <button
      ...
      onClick={() => login()}
      disabled={disabled}
      className="startup-login-oauth-btn"
    >
...
export function LoginPage() {
  ...
  async function handleGoogleSuccess(tokenResponse) {
    ...
    setPending(true)
    try {
      const data = await postJson('/api/auth/oauth/google', {
  ...
  return (
    <div className="startup-site-shell startup-login-shell">
      ...
      <main className="startup-login-main">
        <div className="startup-login-card">
          <p className="startup-kicker" style={{ textAlign: 'center' }}>Classroom Platform</p>
          ...
          <form onSubmit={submit} className="startup-login-form">
            {mode === 'register' && (
              <input
                value={displayName}
            ...
            />
            {error && (
              <div className="startup-login-error">{error}</div>
            )}
            <button
              type="submit"
              disabled={pending}
              className="startup-btn startup-btn-primary startup-login-submit"
            >
              {pending
                ? 'Please wait…'
                : mode === 'register'
          ...
          <div className="startup-login-divider">
            <span>or continue with</span>
          </div>

          <div className="startup-login-oauth">
            {GOOGLE_CLIENT_ID && (
              <GoogleButton
          ...
          <p className="startup-login-back">
